...
const WORDS_BY_CATEGORY = (() => {
  ...
  const voedsel = [
    ...
    'borrelplank', 'wortel', 'vijgen', 'visstick', 'worstenbroodje', 'kauwgum',
    'schijf van vijf'
  ];

  const beroepen = [
    'acrobaat', 'acteur', 'apotheker', 'archeoloog', 'stand-upcomedian',
    'architect', 'automonteur', 'bakker', 'barista', 'beveiliger', 'bibliothecaris',
    'blogger', 'botanicus', 'brandweerman', 'buschauffeur', 'cardioloog',
    ...
    'jongleur', 'journalist', 'juwelier', 'astroloog', 'slager', 'kapitein',
    ...
    'oogarts', 'opticien', 'orthopeed', 'piloot', 'politicoloog', 'postbode', 'stoffeerder',
    ...
    'lobbyist', 'undercoveragent', 'pionier', 'kustwacht', 'ober',
    'ambtenaar', 'animator', 'auteur', 'bankier', 'belastingadviseur', 'bioloog', 'hoefsmid',
    'diëtist', 'scheikundige', 'schildwacht', 'schoonmaker', 'producent',
    'drogist', 'elektricien', 'forensisch arts', 'huisarts', 'marechaussee',
  ...
  const natuur = [
    ...
    'bloemenveld', 'bosbrand', 'bospad', 'bron', 'dode boom', 'eiland', 'jager',
    'erosie', 'grasland', 'grot', 'jungle', 'kustlijn', 'natuur', 'boswachter',
  ...
  const acties = [
    ...
    'ijsberen', 'klunen', 'knuffelen', 'koken', 'kruipen', 'lachen', 'aanvallen', 'slapen',
    ...
    'wiebelen', 'afrekenen', 'afscheid nemen', 'bakken', 'bellen', 'betalen', 'huilen',
  ...
  const wetenschap = [
    ...
    'causaliteit', 'celsius', 'celkern', 'centrifuge', 'chromosoom', 'biologie',
    ...
    'laboratorium', 'laboratoriumjas', 'laser', 'licht', 'loep', 'magneet', 'paradox',
  ...
  const huishouden = [
    'aanrecht', 'keukenrol', 'theedoek', 'servet', 'wasmachine', 'barbecue', 'theemuts',
    'beker' , 'wijnglas', 'lepel', 'vork', 'kookwekker', 'bezem', 'stofzuiger', 'soeplepel',
    'deurbel', 'rolluik', 'vloerkleed', 'lamp', 'gloeilamp', 'wekker', 'gordijn', 'pollepel',
    'klok', 'boekenkast', 'spiegel', 'tafel', 'stoel', 'bank', 'behang', 'deurmat', 'blender',
    'wasmand', 'prullenbak', 'koffiezetapparaat', 'schoonmaakmiddel', 'smartphone', 'smartwatch',
    'koelkast', 'vriezer', 'magnetron', 'kookpan', 'dekbed', 'snijplank', 'airfryer', 'antenne',
    'oven', 'broodrooster', 'waterkoker', 'mixer', 'sapcentrifuge', 'rijstkoker', 'kookplaat',
    'slowcooker', 'wokpan', 'braadpan', 'koekenpan', 'steelpan', 'rasp', 'zeef', 'tablet',
    'pizzasnijder', 'handdoek', 'badmat', 'douchegordijn', 'maatbeker', 'ovenwant', 'haard',
    ...
    'tuinslang', 'tuinstoel', 'tuintafel', 'parasol', 'plantenbak', 'aluminiumfolie', 'aansteker',
    'soepkom', 'theepot', 'koffiepot', 'broodtrommel', 'koektrommel', 'bakpapier', 'onderzetter',
    'bestek', 'mes', 'theelepel', 'spatel', 'wasrek', 'toiletborstel', 'afwasborstel', 'pepermolen',
    'garde', 'deegroller', 'taartvorm', 'stofdoek', 'mop', 'emmer', 'allesreiniger', 'doos',
    ...
    'schoenenrek', 'sprinkler', 'plantenspuit', 'toilettas', 'broodplank', 'zeeppomp', 'krat',
    'fluitketel', 'blikopener', 'kurkentrekker', 'kookboek', 'weegschaal',  'fruitschaal', 'blik',
    'vuilniszak', 'vuilnisbak', 'afvalcontainer', 'papierbak', 'glasbak', 'gft-bak', 'deurklink',
    'plafondlamp', 'spotje', 'antislipmat', 'vloerbedekking', 'asbak', 'afstandsbediening',
    ...
    'vogelvoer', 'tuinaarde', 'bad', 'douche', 'toilet', 'radiator', 'thermostaatknop', 'fles',
    ...
    'antiek', 'ballon', 'balustrade', 'lampion', 'kaars', 'computer', 'dakpan', 'bierglas',
    'fakkel', 'föhn', 'haardroger', 'hangmat', 'ijsklontje', 'pakketje', 'oplader', 'cadeau',
    'megafoon', 'neonlamp', 'paraplu', 'trofee', 'lichtschakelaar', 'spelcomputer',
    'spaarpot', 'wiel', 'rubberen eend', 'scheermes', 'tandenstoker', 'harde schijf', 'powerbank',
    'schommel', 'speelgoed', 'zonnewijzer', 'tandenborstel', 'tandpasta', 'tent', 'kalender',
    'knuffelbeer', 'bellenblaas', 'trechter', 'theeglas', 'lampenkap', 'brandblusser',
    'dvd', 'blu-ray', 'lenzen', 'gehoorapparaat', 'kruk', 'tuinkabouter', 'fietspomp',
    'zonnescherm', 'vouwstoel', 'campingstoel', 'stekker', 'kruik', 'zaklamp'
  ];
  ...
  const kantoor = [
    ...
    'postvak', 'factuur', 'offerte', 'contract', 'memo', 'notulen', 'presentatie', 'deadline',
    ...
    'receptie', 'koffiepauze', 'lunchpauze', 'handtekening', 'bedrijfswagen', 'leasebak'
  ];
  ...
  const map = { dieren, voedsel, beroepen, kantoor, sport, huishouden, natuur, vervoer, plaatsen, kunst, kleding, religie, fictie, literatuur, acties, misdaad, emoties, landen, gereedschap, muziek, militair, ruimte, wetenschap, geneeskunde, politiek, spreekwoorden };
