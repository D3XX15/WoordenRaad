...
const WORDS = [
  // Dieren
  'aardvarken', 'albatros', 'alpaca', 'baviaan', 'bever', 'bizon', 'blauwvintonijn', 'boomkikker',
  'buffel', 'buldog', 'cheetah', 'chihuahua', 'cobra', 'condor', 'dingo', 'dinosaurus',
  'dolfijn', 'drakehagedis', 'dromedaris', 'duif', 'dwergpinguïn', 'eland', 'elektrische paling', 'fennek',
  'flamingo', 'fret', 'galapagosschildpad', 'gecko', 'gibbon', 'giraffe', 'gorilla', 'goudvis',
  'grizzlybeer', 'guanaco', 'haai', 'hamster', 'havik', 'hermelijn', 'hond', 'hyena',
  'ibis', 'impala', 'inktvis', 'jaguar', 'kaketoe', 'kameleon', 'kangoeroe', 'kat',
  'koala', 'komodovaraan', 'konijn', 'kraanvogel', 'krab', 'krokodil', 'kwallen', 'lama',
  ...
  'vos', 'walvis', 'wasbeer', 'waterbuffel', 'wezel', 'wombat', 'woudaap', 'zebra',
  'zeehond', 'zeemeermin', 'zeeotter', 'zeepaardje', 'zeeschildpad',

  // Voedsel & drinken
  'aardbei', 'ananas', 'appelmoes', 'appeltaart', 'asperges', 'avocado', 'bacon', 'bagel',
  ...
  'koffie', 'kroket', 'kwarktaart', 'lasagne', 'limonade', 'loempia', 'macaron', 'macaroni',
  'marshmallow', 'mayonaise', 'milkshake', 'mochi', 'moussaka', 'mozzarella', 'muffin', 'nasi',
  'noedels', 'nougat', 'olijf', 'omelet', 'pad thai', 'paella', 'pancake', 'pannenkoek',
  ...
  'wiskundige', 'woordvoerder', 'zanger', 'zeebioloog', 'zeiler', 'ziekenhuisdirecteur', 'zoöloog', 'zwemmer',
  // Sport & hobby's
  'aerobics', 'american football', 'atletiek', 'badminton', 'basketbal', 'beachvolleybal', 'biatlon', 'biljarten',
  'BMX', 'bobslee', 'boksen', 'boogschieten', 'bowling', 'breakdance', 'breakdansen', 'cricket',
  'curling', 'dammen', 'discuswerpen', 'dressuur', 'driedaagse', 'duiken', 'estafette', 'fietsen',
  'freerunning', 'frisbee', 'gewichtheffen', 'gokken', 'golfen', 'gymnastiek', 'handbal', 'handboogschieten',
  'hardlopen', 'hindernisloop', 'hockey', 'hoogspringen', 'hordelopen', 'ijshockey', 'skeeleren', 'jetskiën',
  'judo', 'kajakken', 'kanoën', 'karate', 'karting', 'klimmen', 'knikkeren', 'kogelstoten',
  'korfbal', 'lacrosse', 'langebaanschaatsen', 'longboarden', 'marathon', 'motorcross', 'mountainbiken', 'netbal',
  'paardrijden', 'paintball', 'parachutespringen', 'parkour', 'polsstokhoogspringen', 'racketball', 'rafting', 'ringsteken',
  'rodeo', 'roeien', 'rolschaatsen', 'rugby', 'schaatsen', 'schaken', 'schermen', 'schieten',
  'scrabble', 'sjoelen', 'skeleton', 'schansspringen', 'skiën', 'slalom', 'snowboarden', 'speerwerpen',
  'squash', 'stoeien', 'surfen', 'synchroonzwemmen', 'taekwondo', 'tafeltennis', 'tennis', 'trampolinespringen',
  'trefbal', 'triatlon', 'turnen', 'veldrijden', 'verspringen', 'vissen', 'vliegeren', 'vliegvissen',
  'voetbal', 'volleybal', 'waterpolo', 'waterskiën', 'wcpotwerpen', 'wielrennen', 'worstelen', 'yoga',
  'zeilen', 'zwemmen',
  ...
  'spiegel', 'spijker', 'spionagesatelliet', 'springveer', 'stethoscoop', 'stoommachine', 'stopwatch', 'strijkijzer',
  ...
  'trap', 'trein', 'trombone', 'trommel', 'trompet', 'tuba', 'tuimelaar', 'tunnel',
  ...
  // Natuur & weer
  'aardbeving', 'aardverschuiving', 'aardworm', 'blad', 'bloem', 'boom', 'bos', 'branding',
  'bui', 'cactus', 'dageraad', 'dauw', 'droogte', 'duinpan', 'eb', 'golf',
  'hagel', 'herfst', 'heuvel', 'ijsberg', 'ijspegel', 'kiezel', 'klif', 'koraalrif',
  'lavastroom', 'lente', 'maan', 'mist', 'modder', 'mos', 'nevel', 'onweer',
  'paddenstoel', 'paddenvijver', 'planeet', 'plas', 'regen', 'regenboog', 'regenbui', 'rivier',
  'roos', 'rots', 'schemering', 'schimmel', 'sneeuw', 'sneeuwvlok', 'steengroeve', 'ster',
  'storm', 'strand', 'stromend water', 'tornado', 'tsunami', 'tulp', 'veld', 'vijver',
  'vlakte', 'vloed', 'vulkaan', 'vulkaanuitbarsting', 'waterval', 'weide', 'woestijn', 'wolk',
  'woud', 'zandstorm', 'zee', 'zomer', 'zon', 'zonsondergang', 'zonsopgang', 'zwaartekracht',
  ...
  // Gebouwen & plaatsen
  'apotheek', 'aquaduct', 'aquarium', 'bioscoop', 'boerderij', 'bowlingbaan', 'brouwerij', 'brug',
  'bunker', 'camping', 'casino', 'circus', 'dierentuin', 'discotheek', 'fabriek', 'fontein',
  'gevangenis', 'hectometerpaal', 'iglo', 'ijsbaan', 'jachthaven', 'jungle', 'kapperszaak', 'kasteel',
  'kathedraal', 'kerk', 'klokkentoren', 'krantenwinkel', 'kunstmuseum', 'laboratorium', 'lagune', 'loods',
  'lunapark', 'markt', 'moskee', 'museum', 'paleis', 'parkbank', 'parkeergarage', 'poppenkast',
  'pretpark', 'racebaan', 'restaurant', 'schaatsbaan', 'school', 'silo', 'sluis', 'speeltuin',
  'sporthal', 'stad', 'stadion', 'sterrenwacht', 'supermarkt', 'synagoge', 'tandartspraktijk', 'tempel',
  'theater', 'torentje', 'treinstation', 'universiteit', 'vuurtoren', 'watertoren', 'windmolen', 'winkelcentrum',
  'ziekenhuis', 'zwembad',
  // Acties & situaties
  ...
  'maaien', 'naaien', 'omhelzen', 'pesten', 'rennen', 'roeien', 'rollen', 'schilderen',
  'schommelen', 'skiën', 'slapen', 'slingeren', 'snurken', 'springen', 'stoeien', 'struikelen',
  'surfen', 'tikken', 'trampolinespringen', 'vallen', 'vangen', 'verstoppen', 'vliegen', 'vouwen',
  'waggelen', 'wiebelen', 'zeilen', 'zwemmen',
  // Landen & gebieden
  ...
  'klokkenluider', 'kluizenaar', 'kwantumfysica', 'laserschip', 'lawine', 'legitimiteit', 'lobbyist', 'lockdown',
  ...
  'surrogaatmoeder', 'taboe', 'terreurcel', 'tijdreizen', 'totalitarisme', 'transplantatie', 'tribunal', 'tsunami',
  ...
  'zijn vingers branden aan iets', 'zo vader zo zoon', 'door de mand vallen', 'met de gebakken peren zitten', 'de koe bij de horens vatten', 'het bijltje erbij neergooien', 'iemand de wind uit de zeilen nemen', 'met alle winden meedraaien',
