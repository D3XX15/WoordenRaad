...
const WORDS_BY_CATEGORY = (() => {
  ...
  const religie = [
    ...
    'Bijbel', 'Koran', 'Tenach', 'psalm', 'communie', 'koosjer', 'halal', 'haram', 'keppel', 'atheïsme', 'agnost',
  ...
  const acties = [
    ...
    'herinneren', 'liefhebben', 'oplossen', 'teweegbrengen', 'aarzelen', 'takelen', 'oversteken',
  ...
  const emoties = [
    ...
    'speels', 'sociaal', 'aanhankelijk', 'onafhankelijk', 'absurd', 'eervol', 'raar', 'kenau', 'gehoorzaam', 'koppig', 'pech',
...
const MESSAGES_EXCELLENT = [
  ...
  () => `Je mag mee naar het WK woordjes raden 🌍`,
