...
const WORDS_BY_CATEGORY = (() => {
  ...
  const acties = [
    ...
    'eten', 'fluiten', 'gapen', 'geven', 'giechelen', 'gillen', 'gluren', 'groeten', 'tikken',
    'inloggen', 'uitloggen', 'inschenken', 'inslapen', 'juichen', 'kijken', 'klagen', 'kloppen',
    ...
    'plukken', 'praten', 'proberen', 'roepen', 'ruiken', 'ruilen', 'plannen', 'tekenen',
    'schelden', 'schminken', 'schrijven', 'schuilen', 'schuiven', 'slepen', 'pakken',
    'smeken', 'snijden', 'sparen', 'speuren', 'stoppen', 'verdedigen', 'schudden', 'delegeren',
    ...
    'debatteren', 'demonstreren', 'flirten', 'herkennen', 'hijgen', 'improviseren', 'doorsturen',
    ...
    'uploaden', 'reflecteren', 'peinzen', 'raden', 'vergelijken', 'voorspellen'
  ];
...
'raad', 'raam', 'raket', 'recht', 'reis', 'schap', 'schip', 'schot', 'schutter', 'staart',
