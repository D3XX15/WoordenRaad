...
const WORDS_BY_CATEGORY = (() => {
  ...
  const objecten = [
    ...
    'koffer', 'kompas', 'kroon', 'kubus', 'kurketrekker',
    ...
    'tuinkabouter', 'tunnel', 'veiligheidsspeld', 'waaier',
    ...
    'sleutelring', 'brief', 'pakketje', 'cadeau', 'dobbelsteen',
  ...
  const natuur = [
    ...
    'winter', 'wind', 'zon', 'sloot', 'schuw', 'tam', 'migreren',
  ...
  const vervoer = [
    ...
    'helipad', 'auto', 'motor', 'wagen', 'kruiwagen', 'huifkar', 'lijkwagen', 'sneeuwschuiver',
  ...
  const plaatsen = [
    ...
    'standbeeld', 'strandtent', 'supermarkt', 'synagoge', 'tandartspraktijk',
    ...
    'boerenschuur', 'stal', 'kapel', 'poolcirkel', 'slachthuis'
  ];
  ...
  const militair = [
    ...
    'geweer', 'pistool', 'machinegeweer', 'zwaard', 'bunker', 'fort',
    ...
    'alliantie', 'bezetting', 'vaandel', 'schouderstuk', 'rang', 'staatsgreep',
    ...
    'medaille', 'schreeuw', 'aanvallen', 'verdediging', 'wapen', 'ransel',
  ...
  const gereedschap = [
    ...
    'stroomgenerator', 'windturbine', 'dynamo', 'liniaal', 'weegschaal', 'gereedschapskist',
    ...
    'plamuurmes', 'roerder', 'cementmixer', 'hoogteschaffer',
    'nijptang', 'werktafel', 'lijmspuit', 'noodstroomgenerator', 'stofopvangzak',
    'boorset', 'luchtcompressor', 'verfspuit', 
    'verfafbijter', 'ontvetter', 'ontroesters', 'beschermkapjes',
    'zaagblad', 'rol', 'spijkertje', 'schroefje', 'boortje',
    'sloopkogel', 'hijskraan', 'moker', 'vuurhaard', 'kachel',
  ...
  const ruimte = [
    ...
    'Apollo', 'SpaceX', 'gps-tracker', 'hemellichaam', 'sterrenbeeld', 'Grote Beer',
  ...
  const huishouden = [
    ...
    'grasmaaier', 'heggenschaar', 'tuinstoel', 'tuintafel', 'parasol',
    ...
    'schoffel', 'bladblazer', 'tuinschep', 'plantenbak', 'compostbak',
    'regenwatertank', 'sprinkler', 'tuinkruiwagen', 'plantenspuit', 'onkruidsteker',
