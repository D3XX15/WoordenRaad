...
const WORDS_BY_CATEGORY = (() => {
  const dieren = [
    ...
    'guppie', 'haai', 'haas', 'hagedis', 'hamster', 'havik', 'prooidier',
    ...
    'slak', 'slang', 'snoek', 'specht', 'sperwer', 'spin', 'roedel', 'kudde',
    'bidsprinkhaan', 'stekelvarken', 'steur', 'stier', 'stinkdier', 'stokstaartje',
    'struisvogel', 'tapir', 'tarantula', 'tijger', 'toekan', 'tor', 'kakkerlak',
    ...
    'worm', 'wrattenzwijn', 'zebra', 'zeehond', 'zeeotter', 'bonobo',
    ...
    'hommel', 'vlooien', 'pissebed', 'glimworm', 'meikever',
    'mot', 'haan', 'eend', 'gans', 'kalkoen', 'geit',
    'varken', 'ezel', 'pony', 'lam', 'reuzenhaai', 'merel',
    'spookdier', 'vis', 'capibara', 'gordeldier', 'gier',
    'papegaaiduiker', 'piranha', 'wandelende tak'
  ];

  const voedsel = [
    'aardappel', 'aardappelpuree', 'aardbei', 'abrikoos', 'amaretto', 'ananas',
    'andijvie', 'appelmoes', 'appelsap', 'appeltaart', 'asperges', 'avocado',
    'bacon', 'bagel', 'baguette', 'balsamico', 'bami', 'banaan', 'hamburger',
    ...
    'broccoli', 'brood', 'brownie', 'bruine bonen', 'caesarsalade', 'karamel', 'nougat',
    'carpaccio', 'cashewnoot', 'champignon', 'cheesecake', 'chipolata', 'chips', 'noten',
    'chocolade', 'churros', 'ciabatta', 'citroen', 'citroentaart', 'cola', 'tapenade',
    'corndog', 'couscous', 'cranberrysap', 'croissant', 'crème brûlée', 'curry', 'omelet',
    'dadel', 'donut', 'doperwt', 'drakenvrucht', 'druiven', 'eclairs', 'hummus', 'olijf',
    'ei', 'enchilada', 'energiedrank', 'erwtensoep', 'espresso', 'falafel', 'nasi',
    'feta', 'fondue', 'friet', 'frikandel', 'frisdrank', 'fruitsalade', 'noedels',
    'garnaal', 'gazpacho', 'gehaktbal', 'geitenkaas', 'gelato', 'gerst', 'nectarine',
    'gin-tonic', 'goulash', 'granaatappel', 'groenten', 'groentesoep', 'gyros', 'paprika',
    'jalapeno', 'jus', 'kaas', 'kaasfondue', 'kaassoufflé', 'kaneelbroodje', 'parmezaan',
    'kappertjes', 'kapsalon', 'kastanje', 'kerrieworst', 'kersensap', 'kip', 'pasta',
    'kipnuggets', 'koffie', 'kokosmelk', 'komkommer', 'koriander', 'kroket', 'penne',
    'kwark', 'kwarktaart', 'lamsvlees', 'lasagne', 'latte', 'limonade', 'salami', 'paella',
    'linzen', 'loempia', 'lychee', 'macaron', 'macaroni', 'mango', 'hazelnoot', 'hotdog',
    'marshmallow', 'mayonaise', 'meloensap', 'milkshake', 'miso', 'mosterd', 'olijfolie',
    'perzik', 'pesto', 'piccalilly', 'pindakaas', 'pistache', 'pitabrood', 'pannenkoek',
    'pizza', 'poffertjes', 'pommes frites', 'pompoen', 'popcorn', 'prei', 'mueslireep',
    'pruim', 'pulled pork', 'quiche', 'rabarber', 'radijs', 'ratatouille', 'mozzarella',
    'ravioli', 'ricotta', 'rijstpap', 'rijsttafel', 'risotto', 'rode wijn', 'passievrucht',
    'roggebrood', 'rolmops', 'roomijs', 'rozijnen', 'rucola', 'rum', 'ijs', 'muffin',
    'salade', 'sandwich', 'sap', 'satésaus', 'scones', 'selderij', 'honing', 'lolly',
    'sinaasappel', 'slagroom', 'smoothie', 'snoep', 'soep', 'sojasaus', 'poke bowl',
    'soufflé', 'spaghetti', 'spek', 'spinazie', 'stamppot', 'stoofpot', 'zuurvlees',
    'strudel', 'suiker', 'sushi', 'taart', 'taco', 'vitamine', 'zonnebloempitten',
    'tartaar', 'teriyaki', 'thee', 'tiramisu', 'toast', 'tomatensaus', 'quinoa',
    'tomatensoep', 'tompouce', 'tortilla', 'truffel', 'ui', 'eiwit', 'vet', 'roti',
    'uiensoep', 'vanillepudding', 'wafel', 'walnoot', 'watermeloen', 'koolhydraat',
    'witlof', 'witte wijn', 'wrap', 'yoghurt', 'zuurkool', 'zuur', 'zout', 'zoet', 'bitter',
    'appelstroop', 'beschuit', 'boontjes', 'erwten', 'flensje', 'gehakt', 'gevulde koek',
    'hagelslag', 'hutspot', 'jenever', 'karnemelk', 'kokos', 'krentenbollen', 'pinda',
    'kruidenboter', 'melk', 'muesli', 'ontbijtkoek', 'pap', 'peperkoek', 'pepernoot',
    'rijst', 'rookworst', 'speculaas', 'stroopwafel', 'tosti', 'vla', 'pecannoot',
    'wentelteefje', 'wittebrood', 'suikerspin', 'aardpeer', 'ansjovis', 'rode kool',
    'bamischijf', 'biet', 'bloedworst', 'brie', 'bami pangang', 'pistolet', 'sambal',
    'courgette', 'döner', 'eendenborst', 'eierkoek', 'filet american', 'panna cotta',
    'gember', 'guacamole', 'grillworst', 'havermout', 'inktvisringen', 'ierse koffie',
    'kalfsvlees', 'kapucijners','kaviaar','kibbeling', 'knoflook', 'koolraap', 
    'kruidnoten', 'lekkerbek','leverworst', 'limoen', 'maïs', 'mandarijn', 'matse',
    'merengue', 'nasischijf', 'nootmuskaat', 'oliebol', 'paaseitje', 'paksoi', 
    'sardientje', 'saté', 'saucijzenbroodje', 'shoarma', 'snert', 'sparerib',
    'spruitje', 'stokbrood', 'tapas', 'taugé', 'tofu', 'venkel', 'wasabi',
    'borrelplank', 'wortel', 'vijgen', 'visstick', 'worstenbroodje',
    'schijf van vijf'
  ];

  const beroepen = [
    'accountant', 'acrobaat', 'acteur', 'apotheker', 'archeoloog', 'stand-upcomedian',
    ...
    'chef-kok', 'chiropractor', 'chirurg', 'circusdirecteur', 'clown', 'gastronoom',
    'voetbalcoach', 'cowboy', 'croupier', 'danser', 'dansleraar', 'data-analist', 'verzorger',
    'dermatoloog', 'dierenarts', 'dierentrainer', 'diplomaat', 'documentairemaker', 'schoenmaker',
    'dokter', 'dronepiloot', 'duikinstructeur', 'econoom', 'ethisch hacker', 'examinator', 'kok',
    'geograaf', 'geoloog', 'gids', 'glazenwasser', 'illusionist', 'grafisch ontwerper', 'kassière',
    'gynaecoloog', 'handelaar', 'hersenchirurg', 'hovenier', 'hypnotherapeut', 'tegelzetter',
    'immunoloog', 'informaticus', 'ingenieur', 'inspecteur', 'kraamverzorger', 'begeleider',
    'jager', 'jongleur', 'journalist', 'juwelier', 'promotie', 'astroloog', 'slager', 'kapitein',
    'laborant', 'lasser', 'leraar', 'loodgieter', 'luchtverkeersleider', 'sommelier', 'kinderarts',
    'makelaar', 'matroos', 'meteoroloog', 'microbioloog', 'kruidenier', 'stadsplanner', 'klusjesman',
    'moleculair bioloog', 'monteur', 'neuroloog', 'notaris', 'radioloog', 'psycholoog', 'socioloog',
    'oogarts', 'opticien', 'orthopeed', 'piloot', 'piraat', 'politicoloog', 'postbode', 'stoffeerder',
    'strateeg', 'stratenmaker', 'stuntman', 'systeembeheerder', 'revalidatiearts', 'farmaceut',
    'tatoeëerder', 'taxichauffeur', 'taxidermist', 'timmerman', 'tolk', 'kweker', 'fysiotherapeut',
    ...
    'aannemer', 'burgemeester', 'cabaretier', 'ijsverkoper', 'kaarsenmaker', 'profvoetballer',
    'reddingswerker', 'straatveger', 'trambestuurder', 'vrijwilliger', 'gameontwikkelaar',
    'lobbyist', 'undercoveragent', 'pionier', 'kluizenaar', 'kustwacht', 'manager', 'ober',
    'ambtenaar', 'animator', 'auteur', 'bankier', 'belastingadviseur', 'bioloog', 'hoefsmid',
    'boswachter', 'diëtist', 'scheikundige', 'schildwacht', 'schoonmaker', 'producent',
    ...
    'politiecommissaris', 'rechter', 'rijinstructeur', 'secretaris', 'schappenvuller',
    'stadsgids', 'stewardess', 'therapeut', 'verloskundige', 'vertaler', 'psychiater',
    'vrachtwagenchauffeur', 'zorgverlener', 'zwemleraar', 'fietsenmaker', 'glazenmaker',
    'conducteur', 'douanier', 'ecoloog', 'figurant', 'investeerder', 'kraanmachinist',
    'machinist', 'molenaar', 'parkeercontroleur', 'pedicure', 'recruiter', 'receptionist', 
    'kapper', 'reisleider', 'restaurateur', 'stukadoor', 'wegwerker', 'webdesigner'
  ];
  ...
  const sport = [
    ...
    'ijshockey', 'jiu-jitsu', 'joggen', 'judo', 'kaatsen', 'kanoën', 'puzzel', 'turnen',
    ...
    'trampoline', 'vogelspotten', 'stoepkrijten', 'weven', 'gezelschapsspel', 'escaperoom',
    ...
    'modeltrein', 'legoblokje', 'puzzelstuk', 'kaarten', 'monopoly', 'dobbelsteen', 'domino'
  ];

  const natuur = [
    'aardbeving', 'aardverschuiving', 'algen', 'atlas', 'bamboe', 'bergtop',
    'blad', 'bliksem', 'bloem', 'boom', 'bos', 'branding', 'zwerfkei', 'eb',
    'brandnetels', 'bronwater', 'bui', 'cactus', 'compost', 'dauw', 'delta',
    'ecosysteem', 'fjord', 'fossiel', 'getijden', 'geiser', 'goud', 'strand',
    'greppel', 'hagel', 'herfst', 'herfstblad', 'heuvel', 'hittegolf', 'storm',
    'ijsberg', 'ijspegel', 'ijsschots', 'ijsvorming', 'inham', 'keien', 'loof',
    'kiezel', 'klif', 'koraal', 'koraalrif', 'lavastroom', 'lente', 'droogte',
    'luchtvochtigheid', 'mangrovebos', 'maretak', 'meander', 'mist', 'modder',
    'moeras', 'monsoen', 'morgenrood', 'mos', 'naaldboom', 'nevel', 'duin',
    'oase', 'oceaan', 'orkaan', 'paddenstoel', 'paddenvijver', 'dennennaald',
    'plas', 'poollicht', 'regen', 'regenboog', 'regenbui', 'regenwoud', 'hars',
    'rivier', 'riviermonding', 'roos', 'rots', 'rotsbodem', 'savanne', 'dijk',
    'schemering', 'schimmel', 'sneeuw', 'sneeuwvlok', 'sneeuwstorm', 'steengroeve',
    'toendra', 'tornado', 'tropische regen', 'tsunami', 'tulp', 'uiterwaarde',
    'vallei', 'veen', 'veld', 'vijver', 'vlakte', 'vloed', 'wild', 'stikstof',
    'vulkaan', 'vulkaanuitbarsting', 'waterval', 'weide', 'windvlaag', 'woestijn',
    'wolk', 'woud', 'zandstorm', 'zeewind', 'zomer', 'marmer', 'stroomversnelling',
    'zonsondergang', 'zonsopgang', 'schelp', 'schaduw', 'berk', 'eik', 'ravijn',
    'graan', 'kastanjeboom', 'klaver', 'korenbloem', 'lavendel', 'meidoorn',
    'narcis', 'populier', 'wilg', 'viooltje', 'afgrond', 'gletsjer', 'zee',
    'lawine', 'draaikolk', 'turbulentie', 'akker', 'beek', 'bergpas', 'kurk',
    'bloemenveld', 'bosbrand', 'bospad', 'bron', 'dode boom', 'eiland',
    'erosie', 'grasland', 'grot', 'jungle', 'kustlijn', 'natuur',
    'volle maan', 'onweersbui', 'oerbos', 'permafrost', 'polder',
    'rivieroever', 'rotsklif', 'schors', 'steentijd', 'steppegras',
    'stroomgebied', 'stuifzand', 'terp', 'waterput', 'wildernis', 'stofwolk',
    'windstil', 'zandbank', 'zandvlakte', 'zeebodem', 'zeestroming', 'zeewier',
    'zilt', 'zoetwatermeer', 'zonnestraling', 'zonsverduistering', 'zoutvlakte',
    'zonnebloem', 'koolzaad', 'heide', 'waterlelie', 'riet', 'stroompje',
    'bosrand', 'bosje', 'struikgewas', 'braamstruik', 'vlierbes',
    'es', 'iep', 'beuk', 'hulst', 'klimop', 'varens', 'stromend water',
    'steen', 'zeegras', 'braam', 'eikel', 'dennenappel', 'framboos',
    'boomgaard', 'boterbloem', 'madeliefje', 'distel', 'archipel',
    'vruchtvlees', 'stuifmeel', 'dooi', 'rijp', 'ijzel', 'aardkorst',
    'bladerdek', 'conifeer', 'den', 'gebergte', 'graniet', 'horizon',
    'kalksteen', 'lagedrukgebied', 'lelie', 'magma', 'munt', 'stekel',
    'winter', 'wind', 'sloot', 'vloedgolf', 'wad', 'zwam'
  ];
  ...
  const vervoer = [
    ...
    'dronepost', 'dubbeldekker', 'duikboot', 'elektrische auto', 'elektrische scooter',
  ...
  const plaatsen = [
    ...
    'restaurant', 'ruïne', 'sauna', 'schaatsbaan', 'school', 'silo', 'drielandenpunt',
  ...
  const religie = [
    'reïncarnatie', 'wedergeboorte', 'meditatie', 'ketter',
  ...
  const filosofie = [
    'nihilisme', 'paradox', 'filosoof', 'humanisme', 'absurdisme', 'retoriek',
    'materialisme', 'marxisme', 'logica', 'ethiek', 'vrije wil', 'waarheid',
    'bewustzijn', 'egoïsme', 'redenering', 'argument', 'cynisme', 'anarchisme',
    'rationalisme', 'idealisme', 'stoïcisme', 'scepticisme', 'postmodernisme',
    'deductie', 'abstract', 'twijfel', 'kennis', 'intuïtie', 'essentie',
    'moraal', 'deugd', 'plicht', 'Socrates', 'Plato', 'Aristoteles', 'Nietzsche',
    'Voltaire', 'Schrödingers kat', 'subjectief', 'objectief', 'stelling',
    'ideologie', 'ego', 'perceptie', 'tijdgeest', 'zingeving', 'autonomie',
    'gelijkheid', 'rechtvaardigheid', 'solidariteit', 'authentiek'
  ];
  ...
  const literatuur = [
    ...
    'woordenboek', 'encyclopedie', 'tijdschrift', 'krant', 'bestseller', 'redacteur'
  ];

  const kunst = [
    'kunstcriticus', 'kunstenaar', 'schilder', 'schilderen', 'schilderij',
    'beeldhouwer', 'verfpalet', 'schildersezel', 'kleurpotlood', 'viltstift',
    'aquarelverf', 'kwast', 'boetseerklei', 'penseel', 'muurschildering',
    'beeldje', 'standbeeld', 'illustrator', 'fotograaf',
    'museumconservator', 'museum', 'galerie', 'theater', 'amfitheater',
    'olieverf', 'ets', 'mozaïek', 'collage', 'graffiti', 'boetseren',
    'sculptuur', 'portret', 'stilleven', 'schets', 'canvas', 'spuitbus',
    'surrealisme', 'realisme', 'pop-art', 'abstract', 'Rembrandt', 'film',
    'Van Gogh', 'Vermeer', 'Mondriaan', 'Picasso', 'ballet', 'animator',
  ...
  const misdaad = [
    ...
    'afpersen', 'kidnappen', 'gijzelen', 'smokkelen', 'brandstichten',
    ...
    'zakkenroller', 'oplichter', 'valsmunterij', 'witwassen', 'moord',
    'diefstal', 'alibi', 'verdachte', 'aanklacht', 'advocaat', 'celstraf',
    'taakstraf', 'borgsom', 'huiszoeking', 'arrestatie', 'verhoor', 'vonnis',
    'openbaar ministerie', 'rechtszaak', 'vluchtroute', 'vluchtauto',
    'ooggetuige', 'vingerafdruk', 'crimineel', 'drugs', 'drugskartel',
    'heling', 'signalement', 'misdrijf', 'delict', 'tbs', 'vrijspraak',
    'conflict', 'moordwapen', 'seriemoordenaar', 'losgeld', 'enkelband',
    'huisarrest', 'bewijsstuk', 'bloedspoor', 'hitman', 'smokkelwaar',
    'drugsdealer', 'stalking', 'phishing', 'maffia', 'geweld'
  ];

  const acties = [
    'applaudisseren', 'fluisteren', 'gebaren', 'gooien', 'graven', 'huppelen',
    'ijsberen', 'klunen', 'knuffelen', 'koken', 'kruipen', 'lachen', 'aanvallen',
    'lopen', 'maaien', 'naaien', 'omhelzen', 'pesten', 'rennen', 'schreeuwen',
    'rollen', 'slapen', 'snurken', 'struikelen', 'tikken',
    ...
    'sms-en', 'appen', 'mailen', 'posten', 'liken', 'kwetsen', 'doneren',
    ...
    'bezorgen', 'inpakken', 'sjouwen', 'tillen', 'dragen', 'uitstellen',
    'timmeren', 'zagen', 'boren', 'schroeven', 'metselen', 'zingen',
    'spelen', 'stampvoeten', 'opdrukken', 'rekken', 'afwassen', 'confronteren',
    'manipuleren', 'dweilen', 'knippen', 'logeren', 'ontbijten', 'strijken', 'stofzuigen',
    'vegen', 'beschuldigen', 'commanderen', 'condoleren', 'feliciteren',
  ...
  const emoties = [
    ...
    'beschaamd', 'schuldig', 'wantrouwig', 'achterdochtig', 'hoopvol', 'gespannen', 'schuw',
    'overprikkeld', 'nerveus', 'onrustig', 'overbelast', 'prikkelbaar', 'uitgeput', 'tam',
    'speels', 'sociaal', 'teruggetrokken', 'vermijdend', 'aanhankelijk', 'onafhankelijk',
    'gehoorzaam', 'koppig', 'impulsief', 'voorzichtig', 'minderwaardig', 'opgefokt',
  ...
  const wetenschap = [
    ...
    'joule', 'kelvin', 'kernfusie', 'kernsplijting', 'kilogram', 'robot',
    ...
    'natuurkunde', 'neutron', 'observatie', 'ondertoon', 'onderzoeksinstituut',
    'oxidatie', 'pesticide', 'pH-waarde', 'pipet', 'plagiaat', 'precisie',
    'proton', 'publicatie', 'radioactiviteit', 'reactie', 'reageerbuisje',
  ...
  const geneeskunde = [
    ...
    'PTSS', 'quarantaine', 'receptor', 'reflex', 'reflectie', 'rehabilitatie', 'ontsteking',
    ...
    'zenuwstelsel', 'orgaandonatie', 'EHBO-kit'
  ];

  const politiek = [
    'anarchie', 'democratie', 'dictator', 'fascisme', 'imperialisme', 'nationalisme',
    'diplomatie', 'bureaucratie', 'legitimiteit', 'avondklok', 'belasting',
    'revolutie', 'staking', 'volksopstand', 'vluchteling', 'sancties', 'schandaal',
    'censuur', 'crisis', 'oligarchie', 'soevereiniteit', 'vetorecht', 'xenofobie',
    'dilemma', 'discriminatie', 'erfenis', 'faillissement', 'fusie', 'stakingsrecht',
    ...
    'schijnheilig', 'taboe', 'uitzetting', 'verjaring', 'vervreemding', 'beschaving',
    'coalitie', 'oppositie', 'verkiezingen', 'stemmen', 'verkiezingscampagne',
    ...
    'privatisering', 'verdrag', 'VN', 'NAVO', 'EU', 'traditie', 'mening', 'rente',
    ...
    'verkiezingsprogramma', 'coalitieakkoord', 'informateur', 'formateur', 'woningmarkt',
    ...
    'raadslid', 'gedeputeerde', 'staatsschuld', 'BTW', 'inkomstenbelasting',
    'vermogensbelasting', 'accijns', 'handelsakkoord', 'handelspartner',
  ...
  const muziek = [
    ...
    'saxofoon', 'klarinet', 'fluit', 'dwarsfluit', 'blokfluit', 'harp',
    'fagot', 'hobo', 'didgeridoo', 'piano', 'vleugel', 'orgel', 'elpee',
    'accordeon', 'synthesizer', 'keyboard', 'trommel', 'xylofoon',
    'microfoon', 'luidspreker', 'versterker', 'mengpaneel', 'grammofoon',
    'platenspeler', 'koptelefoon', 'muziekdoos', 'notenbalk', 'orgelpijp',
    'muziek', 'orkest', 'koor', 'symfonie', 'opera', 'jazz', 'albumhoes',
    'blues', 'rock', 'pop', 'rap', 'hiphop', 'klassiek', 'componeren',
    'reggae', 'soul', 'folk', 'punk', 'metal', 'elektronische muziek',
    'akkoord', 'melodie', 'ritme', 'beat', 'refrein', 'solo', 'altviool',
    ...
    'kapelmeester', 'bandlid', 'producer', 'pianospelen', 'djembé',
    ...
    'mondharmonica', 'kazoo', 'tamboerijn', 'conservatorium', 'cello',
    'songwriter', 'geluidstechnicus', 'lichtontwerper', 'tourmanager',
    'groupie', 'geluidsinstallatie', 'podium',
    'akoestisch', 'repetitieruimte', 'muziekschool',
    'muziekfestival', 'gitaarsolo', 'remix', 'mashup', 'cover',
    'strijkorkest', 'fanfare', 'jazzband', 'rockband', 'liveband',
    'popgroep', 'duo', 'trio', 'kwartet', 'solist', 'muziekzaal',
    'tenor', 'sopraan', 'alt', 'koorzanger', 'cassette', 'cd',
    'koorlid', 'koordirigent', 'muziekvideo', 'platenlabel',
    'muziekuitgever', 'auteursrecht', 'royalties', 'streaming',
    'discjockey', 'turntable', 'beatmaker', 'sample', 'viool',
    'openluchtconcert', 'jamsessie', 'nachtclub', 'poppodium',
  ...
  const kleding = [
    'armband', 'avondjurk', 'bodycam', 'handtas', 'horloge', 'ketting',
    ...
    'blouse', 'rok', 'jurk', 'minirok', 'jumpsuit', 'tuinbroek', 'wol',
  ...
  const militair = [
    ...
    'luchtmacht', 'landmacht', 'commando', 'parachutist', 'verkenner', 'kazerne',
    ...
    'raketschild', 'luchtafweer', 'radar', 'sonar', 'gevaarlijk', 'gevechtsvliegtuig',
    'nachtkijker', 'verrekijker', 'veldtent', 'veldhospitaal',
    'wapenopslag', 'munitiedepot', 'schietbaan', 'hindernisbaan', 'geheime boodschap', 'grenscontrole',
    'saluut', 'wachtpost', 'identiteit', 'noodrantsoen', 'veldfles', 'kaartlezen',
    'veiligheidszone', 'bufferzones', 'neutrale zone', 'demilitarisatie', 'vredesmissie', 'VN-missie',
    'alliantie', 'bezetting', 'vaandel', 'rang', 'staatsgreep', 'wapen',
    'bevrijding', 'overwinning', 'nederlaag', 'stadsbelegering', 'blokkade', 'kruisboog',
  ...
  const gereedschap = [
    'hamer', 'schaar', 'sleutel', 'moersleutel', 'schroefsleutel', 'tang', 'zaag', 'beitel',
    'hooivork', 'hark', 'gieter', 'borstel', 'ladder', 'moker', 'kettingzaag', 'naaimachine',
    'stroomgenerator', 'windturbine', 'dynamo', 'liniaal', 'weegschaal', 'waterpas', 'boormachine',
    'spijker', 'smeedijzer', 'telraam', 'aardappelschiller', 'betonmixer', 'touwladder', 'zeis',
  ...
  const ruimte = [
    'astronaut', 'ruimtevaart', 'ruimtewetenschapper', 'raket', 'space shuttle',
    ...
    'ISS', 'seconde', 'Pluto', 'big bang', 'heelal', 'asteroïde', 'komeetstaart',
    'meteorenregen', 'vallende ster', 'ruimtecapsule', 'ruimtewandeling',
    'ruimtetelescoop', 'Hubble', 'James Webb', 'gewichtloosheid',
    'zuurstoftank', 'landingsgestel', 'lanceerinstallatie', 'CO2-filter', 'maanmissie',
    'NASA', 'lichtjaar', 'lichtsnelheid', 'sterrenkunde', 'planetarium',
    'relativiteitstheorie', 'oerknal', 'botsende sterrenstelsels',
    'gasreuzen', 'planetenring', 'alien', 'ufo', 'moederschip',
    'magnetische pool', 'poolster', 'evenaar', 'landing op de maan',
    'commerciële ruimtevaart', 'marsrover', 'Voyager', 'kosmonaut', 'luchtsluis',
    'Apollo', 'SpaceX', 'hemellichaam', 'sterrenbeeld', 'Grote Beer',
    'Kleine Beer', 'Tweelingen', 'Maagd', 'Waterman', 'krater', 'sterrenkundige',
    'koppelingssysteem', 'zonnepanelen', 'gyroscoop', 'hitteschild',
    'stratosfeer', 'magnetisch veld', 'ruimteschip', 'marslandschap'
  ];

  const huishouden = [
    'aanrecht', 'keukenrol', 'theedoek', 'servet', 'wasmachine', 'barbecue',
    'beker' , 'wijnglas', 'lepel', 'vork', 'kookwekker', 'bezem', 'stofzuiger',
    'deurbel', 'rolluik', 'vloerkleed', 'lamp', 'gloeilamp', 'wekker', 'gordijn',
    'klok', 'boekenkast', 'spiegel', 'tafel', 'stoel', 'bank', 'behang', 'deurmat',
    'bureau', 'wasmand', 'prullenbak', 'koffiezetapparaat', 'schoonmaakmiddel',
    'koelkast', 'vriezer', 'magnetron', 'kookpan', 'dekbed', 'snijplank', 'airfryer',
    'blender', 'pollepel', 'soeplepel', 'theemuts', 'kookplaat', 'haard', 'kachel',
    'oven', 'broodrooster', 'waterkoker', 'mixer', 'sapcentrifuge', 'rijstkoker',
    'slowcooker', 'wokpan', 'braadpan', 'koekenpan', 'steelpan', 'rasp', 'zeef',
    'pizzasnijder', 'handdoek', 'badmat', 'douchegordijn', 'maatbeker', 'ovenwant',
    'zeep', 'shampoo', 'conditioner', 'scheerapparaat', 'haarborstel', 'toiletpapier',
    'deken', 'laken', 'kussensloop', 'matras', 'nachtkastje', 'vergiet', 'kledingkast',
    'strijkijzer', 'strijkplank', 'dweil', 'stoffer', 'bloempot', 'vaas', 'fotolijst',
    'tuinslang', 'tuinstoel', 'tuintafel', 'parasol', 'plantenbak', 'aluminiumfolie',
    'soepkom', 'theepot', 'koffiepot', 'broodtrommel', 'koektrommel', 'bakpapier',
    'bestek', 'mes', 'theelepel', 'spatel', 'wasrek', 'toiletborstel', 'afwasborstel', 
    'garde', 'deegroller', 'taartvorm', 'stofdoek', 'mop', 'emmer', 'allesreiniger',
    'schuurspons', 'vaatwasser', 'wasmiddel', 'wasverzachter', 'bijzettafel', 'batterij',
    'salontafel', 'tv-meubel', 'wandkast', 'ladekast', 'dressoir', 'kapstok', 'fotoalbum',
    'schoenenrek', 'sprinkler', 'plantenspuit', 'toilettas', 'broodplank', 'zeeppomp',
    'fluitketel', 'blikopener', 'kurkentrekker', 'kookboek', 'weegschaal',  'fruitschaal',
    'vuilniszak', 'vuilnisbak', 'afvalcontainer', 'papierbak', 'glasbak', 'gft-bak', 'deurklink',
    'bureaulamp', 'plafondlamp', 'spotje', 'antislipmat', 'muismat', 'vloerbedekking', 'asbak',
    'parket', 'laminaat', 'tegels', 'nagelvijl', 'pincet', 'bloemperk', 'tuinverlichting',
    'tuinhek', 'tuinpad', 'vliegenwering', 'vogelbadje', 'vogelhuisje', 'schutting', 'map',
    'vogelvoer', 'tuinaarde', 'bad', 'douche', 'toilet', 'radiator', 'thermostaatknop',
    'rookmelder', 'brievenbus', 'buitenlamp', 'wandspiegel', 'washandje', 'badkamerspiegel',
    'tafelkleed', 'wasknijper', 'bakplaat', 'beslagkom', 'spons', 'kaasschaaf', 'knoflookpers', 
    'onderzetter', 'pepermolen', 'douchekop', 'aansteker', 'afstandsbediening', 'laserpointer',
    'antiek', 'ballon', 'balustrade', 'lampion', 'kaars', 'briefopener', 'computer', 'dakpan',
    'fakkel', 'föhn', 'haardroger', 'hangmat', 'ijsklontje', 'elastiekje', 'pakketje', 'oplader',
    'megafoon', 'neonlamp', 'paraplu', 'papier', 'pen', 'potlood', 'printer', 'projector', 'monitor',
    'spaarpot', 'wiel', 'rubberen eend', 'scheermes', 'tandenstoker', 'harde schijf', 'powerbank',
    'schommel', 'speelgoed', 'zonnewijzer', 'tandenborstel', 'tandpasta', 'tent', 'usb-stick',
    'antenne', 'smartphone', 'tablet', 'laptop', 'toetsenbord', 'muis', 'plakband', 'paperclip',
    'smartwatch', 'drone', 'spelcomputer', 'gum', 'schrift', 'brief', 'bierglas', 'perforator',
    'jojo', 'vlieger', 'blokken', 'knuffelbeer', 'bellenblaas', 'envelop', 'trechter', 'theeglas',
    'postzegel', 'fles', 'blik', 'zak', 'doos', 'krat', 'cadeau', 'breinaald', 'vlag', 'kalender',
    'dvd', 'blu-ray', 'lenzen', 'gehoorapparaat', 'kruk', 'tuinkabouter', 'trofee', 'lichtschakelaar',
    'aktetas', 'zonnescherm', 'vouwstoel', 'campingstoel', 'Post-it', 'agenda', 'stekker', 'kruik',
    'lampenkap', 'brandblusser', 'fietspomp', 'nietmachine', 'rekenmachine', 'zaklamp'
  ];
