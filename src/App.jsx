...
const WORDS = [
  ...
  'om de hete brij heen draaien', 'onder de duim houden', 'op zijn lauweren rusten', 'over de rooie gaan', 'over één kam scheren', 'roet in het eten gooien', 'schijnheilig',
  ...
  'vlak', 'vuur met vuur bestrijden', 'water naar de zee dragen', 'wie niet waagt wie niet wint', 'nieuwe wijn in oude zakken', 'wolf in schaapskleren', 'zijn hand overspelen', 'zijn tanden laten zien',
  ...
  'zo de ouders zongen piepen de jongen', 'iemand een wit voetje halen', 'iets voor zoete koek slikken', 'op de vingers tikken', 'over de schreef gaan', 'voor de vuist weg praten', 'er met de pet naar gooien', 'iemand het hoofd op hol brengen', 'hard aan de weg timmeren',
