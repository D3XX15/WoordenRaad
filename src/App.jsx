...
const LS_CARDS = [
  ...
  "iets op een festival", "iets op een markt", "iets waarbij je concentratie nodig hebt", "een groente", "iets wat geluid maakt", "een stripfiguur",
  "een berg of gebergte", "een dier dat kleiner is dan een kat", "iets wat giftig is", "iets wat rond is", "iets wat kan zwemmen", "een vakantiebestemming",
  "iets wat onzichtbaar is", "een plant", "een muziekinstrument", "iets wat je kunt opvouwen", "iets wat in de zee leeft", "iets waar je boos van wordt",
  ...
  "een schrijver of dichter", "een held of een schurk", "iets wat je met je handen eet", "een (schier)eiland", "iets zachts", "een meubelstuk",
  "iets wat vierkant is", "iets wat kan breken", "iets wat kan groeien", "iets scherps", "iets wat je kan drinken", "iets wat licht geeft",
  "iets wat je op school leert", "een slechte eigenschap", "een goede eigenschap", "een huishoudelijk apparaat", "iets wat je in de winter nodig hebt",
  "een deel van het menselijk lichaam", "iets wat je zelf kunt maken", "iets wat je ziet in een droom", "iets wat je in de garage vindt",
  "iets wat vleugels heeft", "iets geels", "iets blauws", "iets wat lawaai maakt in de nacht", "iets wat je met een afstandsbediening bestuurt",
  "een automerk", "een hondenras", "een voetbalclub", "iets wat je weggooit", "een familielid", "een rivier of meer", "een huisdier",
  "iets wat je in de zomer nodig hebt", "iets wat elektriciteit gebruikt", "iets zoets", "iets zouts", "iets groens", "gereedschap"
];
            ...
            <div className="ls-mode-wrap" style={{borderColor:"#60a5fa"}}>
              ...
              <div className="ls-mode-grid">
                ...
                >
                  <span className="ls-mode-icon">💬</span>
                  <span className="ls-mode-title">Klassiek</span>
                  <span className="ls-mode-desc">Leg of beeld het woord zo duidelijk mogelijk uit.</span>
                </button>
                <button
