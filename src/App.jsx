...
const WORDS = [
  ...
  'buffel', 'buizerd', 'buldog', 'cheetah', 'chihuahua', 'cobra', 'condor', 'dassie',
  ...
  'flesvleermuis', 'fluweelkrab', 'fret', 'galapagosschildpad', 'gecko', 'gibbon', 'gilamonster', 'giraffe',
  'gorilla', 'goudjakhalzen', 'goudvis', 'grizzlybeer', 'guanaco', 'gup', 'haai', 'haas',
  'hagedis', 'hageldis', 'hamster', 'havik', 'hermelijn', 'hond', 'hyena', 'ibis',
  'ijsbeer', 'impala', 'inktvis', 'jaguar', 'jakhals', 'jakhalzen', 'kakapo', 'kaketoe',
  ...
  'luiaard', 'lynx', 'maanvis', 'mangoest', 'mantelbaviaan', 'mantis', 'marmot', 'meerkat',
  'meerval', 'mier', 'miereneter', 'moeflon', 'mol', 'moose', 'mug', 'muil',
  'muilezel', 'muskusrat', 'narwal', 'nerts', 'neusaap', 'neushoorn', 'nijlgans', 'nijlpaard',
  'octopus', 'oehoe', 'okapi', 'olifant', 'olifantenseal', 'ooievaar', 'orang-oetan', 'orca',
  'otter', 'paard', 'panda', 'panther', 'papegaai', 'paradijsvogel', 'parkiet', 'pauw',
  'pelikaan', 'pijlgif kikker', 'pilaarstaarthagedis', 'pinguïn', 'platypus', 'poema', 'poolvos', 'prairiehond',
  'raaf', 'rat', 'reiger', 'rendier', 'reuzenoctopus', 'reuzenpanda', 'roofvogel', 'runderhaas',
  'salamander', 'schapen', 'schildpad', 'schildwants', 'schorpioen', 'slak', 'slang', 'sneeuwluipaard',
  ...
  'bieslook', 'bietensalade', 'bigos', 'bitterbal', 'bitterballen', 'bitterkoekje', 'bladerdeeg', 'blauwe bes',
  'bloemkool', 'boerenkool', 'bolognese', 'bonbons', 'borrelplank', 'bosbessen', 'boterham', 'bouillon',
  'brandnetelsoep', 'broccoli', 'brood', 'broodje aap', 'brownie', 'bruine bonen', 'bruschetta', 'caesarsalade',
  'cannelloni', 'caprese', 'caramel', 'carpaccio', 'cashewnoot', 'ceviché', 'chai', 'champignon',
  ...
  'dim sum', 'donut', 'donuts', 'doperwt', 'drakenvrucht', 'druiven', 'eclairs', 'ei',
  ...
  'jus', 'kaas', 'kaasfondue', 'kaassouffle', 'kaneelbroodje', 'kappertjes', 'kapsalon', 'kastanje',
  ...
  'uiensoep', 'vanillepudding', 'wafel', 'wafels', 'walnoot', 'watermeloen', 'wijn', 'witlof',
  ...
  'judo', 'kaatsen', 'kabouterlopen', 'kajakken', 'kanoën', 'karate', 'karting', 'kegelen',
  'kegelspel', 'kitesurfen', 'klimmen', 'klimwand', 'knikkeren', 'kogelstoten', 'korfbal', 'krachttraining',
  'kunstrijden', 'lacrosse', 'langebaanschaatsen', 'laser tag', 'lijnvissen', 'longboarden', 'luchtfietsen', 'magisch goochelen',
  ...
  'scrabble', 'shorttracksprint', 'sjoelen', 'skeeleren', 'skeleton', 'skiën', 'slalom', 'sleepbootrace',
  'slipstream', 'snowboarden', 'softbal', 'speerwerpen', 'speerworp', 'spijkerbroekgooien', 'squash', 'stoeien',
  ...
  'dennennaald', 'dijk', 'droogte', 'duin', 'duinpan', 'eb', 'ecosysteem', 'estuarium',
  'fern', 'fjord', 'fossiel', 'getijden', 'geyser', 'golf', 'greppel', 'hagel',
  ...
  'maan', 'maansverduistering', 'mangrovebos', 'maretak', 'maré', 'meander', 'mist', 'modder',
  ...
  'schimmelsporen', 'sirocco', 'sneeuw', 'sneeuwvlok', 'sneeuwstorm', 'steengroeve', 'steppenwind', 'ster',
  'stofwolk', 'storm', 'strand', 'stromend water', 'tij', 'toendra', 'tornado', 'tropische regen',
  ...
  'stoomlocomotief', 'submarine', 'suv', 'taxiboot', 'touringcar', 'tractor', 'tram', 'trolleybus',
  'tuk-tuk', 'veerboot', 'veerfiets', 'vierwieler', 'vliegdekschip', 'vliegende schotel', 'vliegtuig', 'vrachtwagen',
  'waterbus', 'watervliegtuig', 'wielerbaan', 'zeilschip', 'zeilvliegtuig', 'zijspan', 'zonneauto', 'zweefvliegtuig',
