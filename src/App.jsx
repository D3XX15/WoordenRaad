...
const CATEGORIES = [
  ...
  { id: "wetenschap",    label: "🔬 Wetenschap & Medisch" },
...
const WORDS_BY_CATEGORY = (() => {
  ...
  const fictie = [
    ...
    'bovennatuurlijk', 'spook', 'griffioen', 'centaur', 'spreuk', 'cycloop',
    'toverdrank', 'fantasy', 'horror', 'roodkapje', 'assepoester', 'sneeuwwitje',
    'doornroosje', 'repelsteeltje', 'pinokkio', 'hans en grietje', 'gnoom',
    'yeti', 'held', 'anticlimax', 'fictief', 'parallel universum', 'zwarte magie',
