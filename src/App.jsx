...
const WORDS_BY_CATEGORY = (() => {
  ...
  const misdaad = [
    ...
    'handhaver', 'handlanger', 'hechtenis', 'pimp', 'hoorzitting', 'huisvredebreuk', 'huurmoordenaar'
  ];
  ...
  const spreekwoorden = [
    ...
    'iets voor de poorten van de hel weghalen',
    'loop naar de hel',
    ...
    'met het handen in het haar zitten',
