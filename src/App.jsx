...
const LS_CARDS = [
  // ── Lijst 1 (origineel) ──
  "een kleur", "een land", "een stad", "een jongensnaam",
  "een meisjesnaam", "een keukengerei", "iets in de tuin", "een beroep",
  "een sport", "iets om te dragen", "iets in de supermarkt", "een voertuig",
  "iets in de badkamer", "een film", "een tv-serie", "een merk", "iets dat koud is",
  "iets dat warm is", "iets dat lang is", "iets in de natuur", "iets op een verjaardag",
  "een gebouw", "iets in een museum", "iets dat je kunt eten",
  "een bloem of boom", "iets in de slaapkamer", "iets op het strand", "iets op een boerderij",
  "iets in een ziekenhuis", "een insect", "een vis", "een vogel", "iets dat je kunt gooien",
  "iets dat glinstert", "iets dat stinkt", "iets dat lekker ruikt", "een speelgoed",
  "iets van hout", "iets van metaal", "iets van plastic", "iets van glas",
  "iets dat je kunt verzamelen", "iets in een tas",
  "iets op kantoor", "iets dat je kunt lezen", "iets in een winkelcentrum",
  "iets van vroeger", "iets op internet", "iets in een speeltuin",
  "iets in een pretpark", "iets in een bioscoop", "een acteur of actrice",
  "een tekenfilmfiguur", "iets in een kasteel", "iets rond kerst",
  "iets rond Sinterklaas", "iets rond Halloween",
  "iets rond carnaval", "iets op een wereldkaart", "iets in de ruimte",
  "iets dat je kunt meten", "iets dat duur is", "iets dat gratis is",
  "iets dat je kunt winnen", "iets dat je kunt verliezen",
  "een getal", "iets dat met water te maken heeft", "iets dat kan exploderen",
  "iets dat kan zweven", "iets dat kan praten",
  "iets in een apotheek", "iets bij de (tand)arts", "iets dat je dagelijks doet",
  ...
  "een uitvinding", "een wetenschapper", "een kunstenaar",
  ...
  "iets dat je kan schoonmaken",
  "iets wat je in de zomer nodig hebt",
  "iets zoets", "iets zouts", "iets groens", "gereedschap",
];
