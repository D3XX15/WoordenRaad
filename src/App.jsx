...
const WORDS = [
  ...
  'hagedis', 'hamster', 'havik', 'hermelijn', 'hond', 'hyena', 'ibis',
  ...
  'bieslook', 'bietensalade', 'bitterbal', 'bitterballen', 'bitterkoekje', 'bladerdeeg', 'blauwe bes',
  ...
  'zijn vingers branden aan iets', 'zo vader zo zoon', 'broodje aap verhaal', 'door de mand vallen', 'met de gebakken peren zitten', 'de koe bij de horens vatten', 'het bijltje erbij neergooien', 'iemand de wind uit de zeilen nemen', 'met alle winden meedraaien',
