...
const WORDS_BY_CATEGORY = (() => {
  ...
  const religie = [
    ...
    'boeddhisme', 'predikant', 'abdij', 'kathedraal', 'kerk', 'klooster', 'geloof',
    'moskee', 'synagoge', 'tempel', 'kapel', 'orthodox', 'heiden', 'begrafenis',
    'christendom', 'islam', 'jodendom', 'hindoeisme', 'sikhisme', 'calvinisme', 'taboe',
    'taoïsme', 'reformatie', 'protestants', 'katholicisme', 'Maarten Luther', 'spiritueel',
    'gebed', 'zonde', 'genade', 'verlossing', 'hemel', 'hel', 'Maria', 'beeldenstorm',
    'vagevuur', 'paradijs', 'karma', 'nirvana', 'ziel', 'heilige geest', 'hagenpreek',
    'schepping', 'doop', 'biecht', 'mis', 'besnijdenis', 'mensoffer', 'zegening', 'zondigen',
    'pelgrimstocht', 'bedevaart', 'vasten', 'wierook', 'ramadan', 'kruistocht', 'gebedshuis',
  ...
  const fictie = [
    ...
    'toverdrank', 'fantasy', 'gnoom', 'ork', 'cyborg', 'Dr. Frankenstein', 'elfjes', 'mythe', 'folklore',
    'demon', 'telepathie', 'helderziend', 'waarzegger', 'gedachtelezen', 'visioen', 'monster',
    'gedaantewisseling', 'klopgeest', 'superheld', 'Hans Christian Andersen', 'bezwering',
    'schaduwwereld', 'gebroeders Grim', 'bosnimf', 'reus', 'ondoden', 'onsterfelijkheid',
  ...
  const literatuur = [
    ...
    'verteller', 'monoloog', 'dialoog', 'metafoor', 'ironie', 'satire', 'symbolisch', 'gedicht',
    'perspectief', 'schrijver', 'scenarioschrijver', 'dichter', 'komedie', 'tragedie', 'flashback',
    'spanningsboog', 'subplot', 'plottwist', 'Nobel literatuurprijs', 'essay', 'poëzie', 'open eind',
    'hyperbool', 'column', 'columnist', 'copywriter', 'boekenclub', 'boekenlegger', 'thema',
    'bladwijzer', 'inleiding', 'nawoord', 'register', 'citaat', 'ghostwriter', 'setting',
    'verhaal', 'woordenboek', 'encyclopedie', 'tijdschrift', 'krant', 'bestseller',
    'prentenboek', 'redacteur', 'auteursrecht', 'luisterboek', 'e-book'
  ];

  const kunst = [
    'kleurgebruik', 'kunstcriticus', 'kunstenaar', 'schilder', 'schilderen', 'schilderij',
    'beeldhouwer', 'verfpalet', 'schildersezel', 'kleurpotlood', 'viltstift', 'compositie',
    'kunstwerk', 'aquarelverf', 'kwast', 'boetseerklei', 'penseel', 'muurschildering', 'film',
  ...
  const misdaad = [
    ...
    'rapporteren', 'identiteitsfraude', 'bankoverval', 'belastingontduiking', 'mensenhandel'
  ];
  ...
  const acties = [
    ...
    'plukken', 'praten', 'proberen', 'roepen', 'ruiken', 'ruilen', 'plannen', 'tekenen', 'schelden',
    'smeken', 'snijden', 'sparen', 'speuren', 'stoppen', 'verdedigen', 'schudden', 'delegeren', 'openen',
    'strelen', 'studeren', 'telefoneren', 'twijfelen', 'uitleggen', 'uitpakken', 'roken', 'kwetsen',
    'verbergen', 'verdwalen', 'vergeten', 'verkopen', 'verliezen', 'verrassen', 'roeren',  'doneren',
    'verzorgen', 'vluchten', 'volgen', 'wachten', 'wassen', 'weggooien', 'inhalen', 'hakken', 'werken',
    'sluipen', 'brandblussen', 'eerste hulp verlenen', 'blindoeken', 'een geheim bewaren', 'liken',
    'misleiden', 'in de rij staan', 'rijbewijs halen', 'piekeren', 'overwinnen', 'piepen', 'hinkelen',
    ...
    'vegen', 'beschuldigen', 'commanderen', 'condoleren', 'feliciteren', 'rijden', 'knagen', 'manipuleren',
  ...
  const emoties = [
    ...
    'leergierig', 'nieuwsgierig', 'onzeker', 'jaloers', 'gefrustreerd', 'verdrietig', 'narcisistisch',
  ...
  const wetenschap = [
    ...
    'laboratorium', 'labjas', 'laser', 'licht', 'loep', 'magneet', 'paradox', 'pipet',
    ...
    'proton', 'publicatie', 'radioactiviteit', 'reactie', 'reageerbuisje', 'chromosoom', 'onderzoek',
    'reductie', 'relatief', 'replica', 'RNA', 'scheikunde', 'spanning', 'straling', 'formule',
    ...
    'ultraviolet', 'variabele', 'verbinding', 'vergrootglas', 'weerspiegeling',
  ...
  const politiek = [
    ...
    'schijnheilig', 'uitzetting', 'verjaring', 'vervreemding', 'beschaving', 'mening',
    ...
    'petitie', 'demonstratie', 'burgerrechten', 'grondrechten', 'privacywet', 'gelijkheid', 'kieslijst',
  ...
  const muziek = [
    ...
    'accordeon', 'synthesizer', 'keyboard', 'trommel', 'xylofoon', 'Spotify', 'indie', 'soul',
    ...
    'blues', 'rock', 'pop', 'rap', 'hiphop', 'klassiek', 'componeren', 'r&b', 'koorlid', 'playlist',
    'reggae', 'volkszanger', 'punk', 'metal', 'elektronische muziek', 'muziekvideo', 'soundtrack',
    'akkoord', 'melodie', 'ritme', 'beat', 'refrein', 'solo', 'altviool', 'platenlabel', 'akoestisch',
    'concert', 'festival', 'repetitie', 'songtekst', 'opname', 'album', 'live optreden', 'muziekschool',
    'operazanger', 'componist', 'gitarist', 'drummer', 'pianist', 'violist', 'single', 'geluidsinstallatie',
    'kapelmeester', 'bandlid', 'producer', 'pianospelen', 'djembé', 'dirigent', 'dj', 'cello',
    'optreden', 'country', 'gospel', 'latin', 'afrobeat', 'musicus', 'zanger', 'bongo', 'alt',
    'disco', 'techno', 'house', 'trance', 'drum and bass', 'ambient', 'tenor', 'sopraan', 'cd',
  ...
  const kleding = [
    ...
    'riem', 'schoenen', 'stropdas', 'sjaal', 'shirt', 'wandelstok', 'sandalen', 'tuinbroek', 
    ...
    'sokken', 'ondergoed', 'beha', 'bikini', 'laarzen', 'legging', 'tanktop', 'longsleeve',
    'oorbel', 'trouwring', 'vlinderdas', 'bretels', 'polsband', 'pantoffels', 'kousen',
    'nekwarmer', 'wanten', 'baret', 'tulband', 'haarband', 'haarspeld', 'sleutelhanger',
    'beenwarmers', 'slippers', 'zonneklep', 'portemonnee', 'piercing', 'boxershort',
    'coltrui', 'overhemd', 'hoodie', 'sweater', 'joggingbroek', 'hemd', 'corset',
    'panty', 'klompen', 'veters', 'hijab', 'boerka', 'bomberjack', 'garderobe',
    'trainingspak', 'hardloopschoenen', 'instappers', 'snowboots', 'laptoptas',
    'mouw', 'capuchon', 'wetsuit', 'motorpak'
  ];
  ...
  const kantoor = [
    ...
    'usb-stick', 'printer', 'projector', 'scanner', 'headset', 'webcam', 'bureau', 'bureaustoel', 'directie',
