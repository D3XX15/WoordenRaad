...
const WORDS_BY_CATEGORY = (() => {
  ...
  const voedsel = [
    ...
    'strudel', 'suiker', 'sushi', 'taart', 'taco', 'tapenade', 'vitamine',
    'tartaar', 'teriyaki', 'thee', 'tiramisu', 'toast', 'tomatensaus',
    'tomatensoep', 'tompouce', 'tortilla', 'truffel', 'ui', 'eiwit', 'vet',
    ...
    'wentelteefje', 'wittebrood', 'suikerspin', 'aardpeer', 'ansjovis',
    'bamischijf', 'biet', 'bloedworst', 'brie', 'bami pangang',
    'courgette', 'döner', 'eendenborst', 'eierkoek', 'filet american',
    ...
    'panna cotta', 'pecannoot', 'pepernoot', 'pinda', 'pistolet',
    'poke bowl', 'quinoa', 'rode kool', 'roti', 'salami', 'sambal',
    ...
    'zonnebloempitten', 'zuurvlees', 'lolly'
  ];

  const beroepen = [
    'accountant', 'acrobaat', 'acteur', 'apotheker', 'archeoloog',
    ...
    'dermatoloog', 'dierenarts', 'dierentrainer', 'diplomaat', 'documentairemaker',
    'dokter', 'dronepiloot', 'duikinstructeur', 'econoom', 'ethisch hacker', 'examinator',
    'farmaceut', 'fotograaf', 'fysiotherapeut', 'gameontwikkelaar', 'gastronoom',
    'geograaf', 'geoloog', 'gids', 'glazenwasser', 'illusionist', 'grafisch ontwerper',
    'gynaecoloog', 'handelaar', 'hersenchirurg', 'hovenier', 'hypnotherapeut',
    'illustrator', 'immunoloog', 'informaticus', 'ingenieur', 'inspecteur',
    'jager', 'jongleur', 'journalist', 'juwelier', 'promotie', 'astroloog',
    ...
    'laborant', 'lasser', 'leraar', 'loodgieter', 'luchtverkeersleider',
    ...
    'postbode', 'producent', 'profvoetballer', 'psychiater', 'psycholoog',
    'radioloog', 'revalidatiearts', 'scenarioschrijver', 'schappenvuller',
    'scheikundige', 'schilder', 'schildwacht', 'schoonmaker', 'schrijver',
    'slager', 'socioloog', 'sommelier', 'stadsplanner', 'stand-upcomedian',
    'strateeg', 'stratenmaker', 'stuntman', 'systeembeheerder',
    'tatoeëerder', 'taxichauffeur', 'taxidermist', 'timmerman', 'tolk',
    ...
    'reddingswerker', 'straatveger', 'trambestuurder', 'vrijwilliger',
    ...
    'schoenmaker', 'stoffeerder', 'tegelzetter', 'verzorger', 'begeleider', 'ober', 'cameraman',
    ...
    'reisleider', 'restaurateur', 'stukadoor', 'wegwerker', 'webdesigner'
  ];
  ...
  const sport = [
    ...
    'ijshockey', 'jiu-jitsu', 'joggen', 'judo', 'kaatsen', 'kanoën', 'puzzel',
  ...
  const objecten = [
    ...
    'antiek', 'armband', 'avondjurk', 'ballon', 'balustrade', 'beeldhouwwerk',
    'bodycam', 'boekenlegger', 'boomerang', 'briefopener', 'camera',
    'computer', 'dakpan', 'roltrap', 'fakkel', 'film', 'föhn',
    'ganzenbord', 'haardroger', 'handtas', 'hangmat', 'heksenketel',
    'horloge', 'ijsklontje', 'kaars', 'ketting',
    'koffer', 'kompas', 'kroon', 'kubus', 'lasso',
    'lampion', 'lantaarn', 'laserpointer', 'luchtballon', 'maillot', 'manchetknoop',
    'masker', 'megafoon', 'molen', 'naaldhak', 'neonlamp', 'paraplu',
    'penseel', 'printer', 'projector', 'reddingsvest', 'regenjas',
    ...
    'springveer', 'stoommachine', 'tandenborstel', 'tandpasta', 'tent',
    'tuinkabouter', 'tunnel', 'veiligheidsspeld', 'waaier', 'lantaarnpaal',
    'wiel', 'zaklamp', 'zandloper', 'zeepbel', 'zeeppomp', 'zenderstation',
    'zetel', 'zonnebril', 'zonnewijzer', 'zweep', 'tandenstoker', 'kleerhanger',
    'elastiekje', 'kurk', 'boodschappentas', 'broek', 'hoed',
    'knoop', 'krijtbord', 'muts', 'papier', 'pen',
    ...
    'brief', 'pakketje', 'cadeau', 'dobbelsteen', 'trouwring',
    'tol', 'jojo', 'vlieger', 'blokken', 'knuffelbeer',
    'modeltrein', 'legoblokje', 'puzzelstuk', 'kaarten', 'monopoly',
  ...
  const natuur = [
    ...
    'oase', 'oceaan', 'orkaan', 'paddenstoel', 'paddenvijver',
    ...
    'stikstof', 'stofwolk', 'storm', 'strand', 'stromend water',
    'toendra', 'tornado', 'tropische regen', 'tsunami', 'tulp', 'uiterwaarde',
    'vallei', 'veen', 'veld', 'vijver', 'vlakte', 'vloed', 'wild',
    ...
    'stroomgebied', 'stuifzand', 'terp', 'waterput', 'wildernis',
    ...
    'ravijn', 'stroomversnelling', 'hars', 'loof',
  ...
  const vervoer = [
    ...
    'graafmachine', 'hangbrug', 'helikopter', 'hoogspoortrein', 'hoverboard',
    ...
    'postkoets', 'racefiets', 'racewagen', 'reddingsboot', 'rijtuig',
    ...
    'wielerbaan', 'zeilschip', 'zijspan', 'zonneauto', 'zweefvliegtuig',
    ...
    'tandemfiets', 'bromscooter', 'quad', 'buggy', 'golfkarretje',
    'cabrio', 'stationwagen', 'terreinwagen', 'minivan', 'camionette',
    'kraanwagen', 'betonmixer', 'vorkheftruck', 'shovel', 'bulldozer',
    ...
    'bagage', 'handbagage', 'reistas', 'ov-chipkaart', 'treinkaartje',
    ...
    'helipad', 'auto', 'motor', 'wagen', 'huifkar', 'lijkwagen', 'sneeuwschuiver',
    'schoolbus', 'rolstoel', 'skateboard', 'vouwfiets', 'laadpaal', 'paardentram', 'zebrapad'
  ];

  const plaatsen = [
    'amfiteater', 'apotheek', 'aquaduct', 'aquarium', 'badhuis',
    ...
    'fontein', 'fruitmarkt', 'galerie', 'gemeentehuis', 'grachtenpand',
    ...
    'megabioscoop', 'monument', 'museum', 'observatorium', 'dolfinarium',
    ...
    'standbeeld', 'strandtent', 'supermarkt', 'tandartspraktijk', 'koffieshop',
    'theater', 'toren', 'treinstation', 'universiteit', 'vakantiepark', 'kolenmijn',
  ...
  const religie = [
    'reïncarnatie', 'wedergeboorte', 'meditatie',
  ...
  const filosofie = [
    'nihilisme', 'paradox', 'filosoof', 'atheïsme', 'agnost', 'humanisme',
  ...
  const misdaad = [
    'vliegtuigkaping', 'politie', 'cel', 'stelen', 'dreigen',
  ...
  const politiek = [
    ...
    'dilemma', 'discriminatie', 'erfenis', 'faillissement', 'fusie',
    ...
    'coalitie', 'oppositie', 'verkiezingen', 'stemmen', 'verkiezingscampagne', 'klimaatwet',
    ...
    'vermogensbelasting', 'accijns', 'handelsakkoord', 'handelspartner', 'economische unie',
  ...
  const muziek = [
    ...
    'theaterzaal', 'akoestisch', 'repetitieruimte', 'muziekschool',
  ...
  const militair = [
    ...
    'capitulatie', 'wapenstilstand', 'tribunaal', 'krijgsraad', 'evacuatie',
  ...
  const gereedschap = [
    ...
    'verfroller', 'kwast', 'verfblik', 'afplaktape', 'kit', 'siliconekit',
  ...
  const huishouden = [
    ...
    'klok', 'boekenkast', 'spiegel', 'tafel', 'stoel', 'bank', 'behang', 'verf',
...
'energie', 'erij', 'explosie', 'factor', 'fiets', 'front', 'gas', 'gebouw', 'tuin',
'geving', 'gever', 'golf', 'graaf', 'grond', 'haven', 'heid', 'herdenking', 'afdruk',
