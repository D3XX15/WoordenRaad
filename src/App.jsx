...
const WORDS_BY_CATEGORY = (() => {
  ...
  const objecten = [
    ...
    'muurschildering', 'beeldje', 'schaal', 'kom', 'kan',
    'kruik', 'theeglas', 'shotglas', 'bierglas', 'champagneglas', 'trofee',
    'urn', 'wapenrusting', 'lans', 'pijl en boog',
  ...
  const natuur = [
    ...
    'bosrand', 'bosje', 'struikgewas', 'braamstruik', 'vlierbes', 'territorium',
    'es', 'iep', 'beuk', 'hulst', 'klimop', 'varens', 'roedel', 'kudde',
    ...
    'ravijn', 'krater', 'stroomversnelling', 'hars', 'loof', 'territoriaal',
  ...
  const filosofie = [
    ...
    'moskee', 'synagoge', 'tempel', 'kapel', 'orthodox', 'heiden',
  ...
  const acties = [
    ...
    'haasten', 'vervelen', 'achtervolgen', 'bazelen', 'broeden',
    ...
    'afpersen', 'kidnappen', 'gijzelen', 'brandstichten', 'piekeren',
    ...
    'spelen', 'stampvoeten', 'opdrukken', 'rekken', 'afwassen',
    'dweilen', 'knippen', 'logeren', 'ontbijten', 'strijken', 'stofzuigen',
  ...
  const wetenschap = [
    ...
    'surrogaatmoeder', 'transplantatie', 'tunnelvisie', 'vaccinatie', 'begrafenis',
    'laboratorium', 'algoritme', 'brainstorm', 'evolutie', 'frictie', 'grafiek',
    'implosie', 'mutatie', 'pesticide', 'onderzoeksinstituut',
    'relatief', 'vergiftiging', 'tijdreizen', 'hersenspoeling',
  ...
  const politiek = [
    ...
    'oligarchie', 'parlementaire democratie', 'totalitarisme', 'soevereiniteit', 'bureaucratie',
    'diplomatie', 'legitimiteit', 'genocide', 'holocaust', 'rebellie', 'revolutie',
    'slavernij', 'staking', 'terreurcel', 'volksopstand', 'vluchteling',
    'inquisitie', 'executie', 'avondklok', 'bankroet', 'belasting', 'beschaving',
    'censuur', 'corruptie', 'crisis', 'cyberpesten', 'dagvaarding',
    ...
    'tweede kamer', 'eerste kamer', 'confrontatie', 'intimidatie', 'manipulatie'
  ];
  ...
  const muziek = [
    ...
    'psalm', 'cha-cha-cha', 'foxtrot', 'quickstep', 'slowfox'
  ];
