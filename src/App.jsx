...
const WORDS_BY_CATEGORY = (() => {
  ...
  const voedsel = [
    ...
    'wortel', 'vijgen', 'visstick', 'worstenbroodje'
  ];
  ...
  const sport = [
    ...
    'biljarten', 'BMX', 'bobslee', 'boksen', 'bowling', 'breakdance', 'doping', 
  ...
  const vervoer = [
    ...
    'boot', 'brandweerwagen', 'bromfiets', 'bus', 'camper', 'GPS',
    ...
    'afrit', 'invoegstrook', 'viaduct', 'perron', 'spoorwegovergang', 'bagageband',
  ...
  const plaatsen = [
    ...
    'megabioscoop', 'monument', 'observatorium', 'dolfinarium', 'landgoed',
    'paleis', 'parkeergarage', 'pier', 'plein', 'poppenkast',
    ...
    'kerkhof', 'kinderdagverblijf', 'klimrek', 'klimbos', 'markthal',
  ...
  const kunst = [
    ...
    'beeldje', 'poster', 'potlood', 'standbeeld', 'illustrator', 'fotograaf',
  ...
  const politiek = [
    ...
    'integratie', 'asielzoeker', 'statushouder', 'tweede kamer', 'eerste kamer',
  ...
  const gereedschap = [
    ...
    'zaag', 'schroevendraaier', 'beitel', 'pikhouweel', 'zeis',
    'hooivork', 'hark', 'gieter', 'borstel', 'ladder', 'moker',
    'touwladder', 'waterpas', 'boormachine', 'kettingzaag', 'naaimachine',
    'stroomgenerator', 'windturbine', 'dynamo', 'liniaal', 'weegschaal',
    'spijker', 'smeedijzer', 'telraam', 'aardappelschiller', 'betonmixer',
    'klem', 'verlengsnoer', 'pomp', 'kabel', 'snoer', 'zekering',
    'waterpomptang', 'steeksleutel', 'inbussleutel', 'schaaf', 'vijl',
    'handzaag', 'figuurzaag', 'cirkelzaag', 'schuurmachine', 'decoupeerzaag',
    'accuboormachine', 'lasapparaat', 'soldeerbout', 'heteluchtpistool',
    'prikpen', 'punttang', 'schroef', 'gradenboog', 'klinknagel', 'snijder',
    'bout', 'moer', 'plug', 'haak', 'kram', 'schoffel', 'bladblazer', 'tuinschep',
    'nagel', 'kittpistool', 'lijmpistool', 'lijmklem', 'bankschroef', 'werkbank',
    'veiligheidshelm', 'veiligheidsbril', 'werkhandschoenen', 'stofmasker',
    'kruiwagen', 'hefboom', 'katrol', 'handkar', 'palletwagen', 'grasmaaier',
    'hijsband', 'touw', 'steiger', 'koevoet', 'breekijzer', 'schuurpapier',
    'freesmachine', 'bankmes', 'stanleymes', 'dieptemeter', 'kniebeschermer',
    'verfroller', 'verfblik', 'afplaktape', 'kit', 'siliconekit',
    'purschuim', 'isolatiemateriaal', 'ducttape', 'perslucht', 'heggenschaar',
    'compressor', 'spijkerpistool', 'houtlijm', 'gereedschapskist',
    'plamuurmes', 'roerder', 'cementmixer', 'hoogteschaffer', 'meetlint',
    'nijptang', 'werktafel', 'lijmspuit', 'noodstroomgenerator', 'stofopvangzak',
    'boorset', 'luchtcompressor', 'verfspuit', 'gehoorbescherming',
    'verfafbijter', 'ontvetter', 'ontroesters', 'beschermkapjes', 'sloopkogel',
    'zaagblad', 'rol', 'spijkertje', 'schroefje', 'boortje', 'hijskraan',
    'gasbrander', 'lasbril', 'koord', 'tegelsnijder'
  ];
  ...
  const huishouden = [
    ...
    'klok', 'boekenkast', 'spiegel', 'tafel', 'stoel', 'bank', 'behang',
    ...
    'pan', 'pollepel', 'soeplepel', 'theemuts', 'kookplaat', 'haard', 'kachel',
    ...
    'tuinstoel', 'tuintafel', 'parasol',  'stroomuitval', 'plantenbak', 'compostbak',
    ...
    'schrobber', 'toiletborstel', 'afwasborstel', 'schuurspons', 'allesreiniger',
    ...
    'regenwatertank', 'sprinkler', 'plantenspuit', 'onkruidsteker', 'toilettas',
    'pannenset', 'braadslede', 'soeppan', 'fluitketel', 'eierdopje', 'broodplank',
    'citruspers', 'blikopener', 'dopjesopener', 'kurkentrekker', 'kookboek',
    'receptenboek', 'keukentimer', 'keukenweegschaal', 'maatlepel', 'spuitzak',
    'cakestandaard', 'rijstzeef', 'vuilniszak', 'vuilnisbak', 'afvalbak',
    'papierbak', 'glasbak', 'gft-bak', 'vloerlamp', 'tafellamp', 'handdoekrek',
