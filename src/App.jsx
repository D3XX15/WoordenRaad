...
const WORDS = [
  ...
  'een goed begin is het halve werk', 'een half woord is genoeg voor een verstandige', 'hoe meer zielen hoe meer vreugd', 'het doel heiligt de middelen', 'de pen is machtiger dan het zwaard', 'beter voorkomen dan genezen', 'eind goed al goed',
  'er is geen roos zonder doornen', 'wie het laatst lacht lacht het best', 'in de nood leert men zijn vrienden kennen', 'met één zwaluw is het nog geen zomer', 'niets is zo oud als de nieuwtjes van gisteren', 'over smaak valt niet te twisten', 'wat de boer niet kent dat eet hij niet',
  'zo de ouders zongen piepen de jongen', 'iemand een wit voetje halen', 'iets voor zoete koek slikken', 'op de vingers tikken', 'over de schreef gaan', 'er met de pet naar gooien', 'iemand het hoofd op hol brengen', 'hard aan de weg timmeren',
