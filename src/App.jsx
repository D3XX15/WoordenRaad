...
const CATEGORIES = [
  ...
  { id: "filosofie",     label: "🕍 Religie & Filosofie" },
...
const WORDS_BY_CATEGORY = (() => {
  ...
  const voedsel = [
    ...
    'uiensoep', 'vanillepudding', 'wafel', 'walnoot', 'watermeloen',
  ...
  const objecten = [
    ...
    'horloge', 'ijsklontje', 'kaars', 'kaarsenhouder', 'ketting',
    ...
    'woordenboek', 'encyclopedie', 'roman', 'tijdschrift', 'krant',
  ...
  const natuur = [
    ...
    'winter', 'wind', 'zon', 'sloot', 'migreren',
  ...
  const plaatsen = [
    ...
    'sluis', 'speeltuin', 'sporthal', 'stad', 'stadion', 'stadshuis', 'gerechtshof',
    'standbeeld', 'strandtent', 'supermarkt', 'tandartspraktijk',
    'theater', 'toren', 'treinstation', 'universiteit', 'vakantiepark',
    ...
    'schaapskooi', 'sportpark', 'stadspark', 'stoep', 'uitkijktoren',
  ...
  const filosofie = [
    'reïncarnatie', 'wedergeboorte', 'nihilisme', 'paradox', 'utopie', 'meditatie',
    'boeddhisme', 'filosoof', 'predikant', 'abdij', 'kathedraal', 'kerk', 'klooster',
    'moskee', 'synagoge', 'tempel', 'kapel', 'orthodox', 'heiden', 'begrafenis',
    'christendom', 'islam', 'jodendom', 'hindoeisme', 'sikhisme',
    'taoisme', 'atheïsme', 'agnost', 'humanisme', 'reformatie',
    'protestantisme', 'katholicisme', 'calvinisme', 'maarten luther',
    'gebed', 'zonde', 'genade', 'verlossing', 'hemel', 'hel', 'Maria',
    'vagevuur', 'paradijs', 'karma', 'nirvana', 'ziel', 'heilige geest',
    'schepping', 'doop', 'biecht', 'mis', 'besnijdenis', 'besnijdenis',
    'pelgrimstocht', 'bedevaart', 'vasten', 'wierook', 'offer', 'zegening',
    'ramadan', 'kruistocht', 'exorcisme', 'bar mitswa', 'hekserij',
    'paus', 'bisschop', 'priester', 'pastoor', 'dominee',
    'imam', 'rabbijn', 'monnik', 'non', 'abt', 'dalai lama',
    'ayatollah', 'apostel', 'profeet', 'heilige', 'martelaar',
    'engel', 'aartsengel', 'duivel', 'demon', 'messias', 'Jezus',
    'bijbel', 'koran', 'torah', 'psalm', 'kruis', 'crucifix',
    'davidster', 'scepter', 'kloostertuin', 'rozenkrans', 'lot',
    'icoon', 'relikwie', 'talisman', 'amulet', 'altaar', 'God',
    'Mekka', 'Jeruzalem', 'pelgrimsoord', 'heiligdom', 'rede', 'bewustzijn',
  ...
  const acties = [
    ...
    'smeken', 'snijden', 'sparen', 'speuren', 'stelen', 'stoppen', 'verdedigen',
    ...
    'misleiden', 'in de rij staan', 'op de vlucht zijn', 'rijbewijs halen',
    ...
    'afpersen', 'kidnappen', 'gijzelen', 'brandstichten', 'piekeren', 'cyberpesten',
    'smokkelen', 'sms-en', 'appen', 'mailen', 'posten', 'liken', 'kwetsen',
    ...
    'spelen', 'stampvoeten', 'opdrukken', 'rekken', 'afwassen', 'confronteren', 'intimideren',
  ...
  const wetenschap = [
    ...
    'doofstom', 'epidemie', 'forensisch onderzoek', 'geheugenverlies', 'hallucinatie',
    'hartstilstand', 'hersenletsel', 'homeopathie', 'hoogtevrees', 'hormoon', 'hypnose',
    'hysterie', 'illusie', 'immuunsysteem', 'injectie', 'keizersnede',
    'migraine', 'narcisme', 'obsessie', 'onderbewustzijn', 'overdosis',
    'overlevingsdrang', 'pandemie', 'paranoia', 'persoonlijkheid', 'PTSS', 'psychiatrie',
    'quarantaine', 'reflectie', 'rehabilitatie', 'schizofrenie', 'stigma',
    'surrogaatmoeder', 'transplantatie', 'tunnelvisie', 'vaccinatie',
    'laboratorium', 'algoritme', 'brainstorm', 'evolutie', 'frictie', 'grafiek',
    'implosie', 'mutatie', 'pesticide', 'onderzoeksinstituut',
    'relatief', 'vergiftiging', 'hersenspoeling',
    'isolatie', 'plagiaat', 'barometer', 'geigerteller', 'bunsenbrander',
  ...
  const politiek = [
    ...
    'diplomatie', 'bureaucratie', 'legitimiteit', 'rebellie', 'avondklok', 'belasting',
    'revolutie', 'slavernij', 'staking', 'terreurcel', 'volksopstand', 'vluchteling',
    'censuur', 'corruptie', 'crisis', 'dagvaarding', 'oligarchie', 'soevereiniteit',
    ...
    'vetorecht', 'xenofobie', 'zwarte markt', 'chantage', 'klokkenluider',
  ...
  const muziek = [
    ...
    'kapelmeester', 'bandlid', 'producer', 'pianospelen', 'djembé spelen',
    ...
    'mondharmonica', 'kazoo', 'tamboerijn', 'conservatorium',
  ...
  const militair = [
    ...
    'kanon', 'kanonskogel', 'katapult', 'handgranaat', 'explosief', 'bajonet', 'executie',
    ...
    'alliantie', 'bezetting', 'vaandel', 'schouderstuk', 'rang', 'staatsgreep', 'wapen',
    ...
    'inlichtingendienst', 'geheime dienst', 'cyberaanval', 'informatieoorlog', 'wapenuitrusting', 'lans',
    'terrorisme', 'zelfmoordaanslag', 'bomaanslag', 'ontvoeringen', 'antitankwapen', 'amfibievoertuig',
  ...
  const ruimte = [
    ...
    'NASA', 'lichtjaar', 'lichtsnelheid', 'horizon', 'sterrenkunde', 'planetarium',
    'relativiteitstheorie', 'oerknal', 'botsende sterrenstelsels',
    'gasreuzen', 'planetenring', 'alien', 'ufo', 'moederschip', 'tijdreizen',
  ...
  const huishouden = [
    ...
    'tuinstoel', 'tuintafel', 'parasol',  'stroomuitval',
    ...
    'plantenbak', 'compostbak',
    'regenwatertank', 'sprinkler', 'plantenspuit', 'onkruidsteker',
    ...
    'behang', 'verf', 'handdoekrek', 'toilettas', 'verlengsnoer',
  ...
  const map = { dieren, voedsel, beroepen, sport, objecten, huishouden, natuur, vervoer, plaatsen, filosofie, acties, emoties, landen, gereedschap, muziek, militair, ruimte, wetenschap, politiek, spreekwoorden };
...
'ment', 'middel', 'minister', 'misdaad', 'monument', 'oord',
...
export default function App() {
  ...
  const onStartTiebreaker = (tiedPlayerIndices) => {
    ...
    const safeCats = ['dieren', 'voedsel', 'beroepen', 'sport', 'objecten', 'natuur', 'emoties', 'landen', 'vervoer', 'plaatsen', 'filosofie', 'muziek', 'acties', 'gereedschap', 'wetenschap', 'ruimte', 'militair', 'politiek', 'huishouden'];
