...
const WORDS_BY_CATEGORY = (() => {
  const dieren = [
    ...
    'worm', 'wrattenzwijn', 'zebra', 'zeehond', 'zeeotter',
  ...
  const politiek = [
    ...
    'privatisering', 'verdrag', 'VN', 'NAVO', 'EU', 'traditie', 'mening',
  ...
  const gereedschap = [
    ...
    'compressor', 'spijkerpistool', 'tacker', 'houtlijm', 'gereedschapskist',
...
'oorlog', 'overleg', 'oxide', 'pad', 'partij', 'planeet', 'proef', 'punt', 
